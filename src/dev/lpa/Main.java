...
//     LocalDate comparisons
    ...
    System.out.println("-------------------------------------------------");
    May5.datesUntil(May5.plusDays(7)).forEach(System.out::println); // stream incl./excl.
    System.out.println("-------------------------------------------------");
    ...
    LocalTime sevenPM = LocalTime.parse("11:59"); // "7:00" can not be parsed, "07:00" can
    LocalTime sevenThirtyPM = LocalTime.parse("19:30:15.1000");
    System.out.println(sevenPM.get(ChronoField.AMPM_OF_DAY)); // 0 -> AM
    System.out.println(sevenThirtyPM.get(ChronoField.AMPM_OF_DAY)); // 1 -> PM
    System.out.println(sevenThirtyPM.getHour());
    System.out.println(sevenThirtyPM.get(ChronoField.HOUR_OF_DAY));
    
    // System.out.println(sevenThirtyPM.get(ChronoField.YEAR)); // not possible for LocalTime
